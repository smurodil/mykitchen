function Preview({ images, ingredients, title, cookingTime, method }) {
  return (
    <>
      <dialog id="my_modal_1" className="modal">
        <div className="w-11/12 max-w-5xl">
          <div className="modal-action rounded-xl bg-white">
            <div className="flex gap-1 rounded-xl p-4 shadow-xl md:grid-cols-2 md:gap-8 md:p-6">
